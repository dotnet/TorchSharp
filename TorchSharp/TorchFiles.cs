...
namespace Torch.IO
{
    ...
    public class THMemoryFile : THFile {
        ...
        public THMemoryFile(CharStorage storage, string mode)
        {
        ...
        /// </summary>
        /// <param name="mode">Standard POSIX file modes: "r", "w", "rw", etc.</param>
        public THMemoryFile (string mode)
        {
        ...
        internal THMemoryFile (HType handle)
        {
            this.handle = handle;
        }
        ...
        public int Size { set { THMemoryFile_longSize(this.handle, value); } }
    }
}