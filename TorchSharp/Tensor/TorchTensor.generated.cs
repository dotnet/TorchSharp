...
namespace TorchSharp.Tensor {
    ...
    public struct ByteTensor : ITorchTensor<byte>
    {
        ...
        public static ByteTensor From(byte[] rawArray)
        {
        ...
        public static ByteTensor Sparse(ITorchTensor<long> indices, ITorchTensor<byte> values, long[] size, string device = "cpu", bool requiresGrad = false)
        {
            ByteTensor.CheckForCUDA (device);
            ...
            unsafe
            {
                fixed (long* psizes = size)
                {
                    return new ByteTensor (THSTensor_sparse (indices.Handle, values.Handle, (IntPtr)psizes, size.Length, (sbyte)ATenScalarMapping.Byte, device, requiresGrad));
                }
            }
        }
        ...
        public ITorchTensor<byte> Add(ITorchTensor<byte> target, int scalar = 1)
        {
        ...
        public ITorchTensor<byte> Mean()
        {
            return new ByteTensor(THSTensor_mean(handle));
        }
        ...
        public static ByteTensor operator +(ByteTensor left, ByteTensor right)
        {
            return (ByteTensor)left.Add(right);
        }

        public static ByteTensor operator *(ByteTensor left, ByteTensor right)
        {
            return (ByteTensor)left.Mul(right);
        }

        public static ByteTensor operator -(ByteTensor left, ByteTensor right)
        {
            return (ByteTensor)left.Sub(right);
        }
    ...
    public struct ShortTensor : ITorchTensor<short>
    {
        ...
        public static ShortTensor From(short[] rawArray)
        {
            return From(rawArray, new long[] { (long)rawArray.Length });
        }
        ...
        public static ShortTensor Sparse(ITorchTensor<long> indices, ITorchTensor<short> values, long[] size, string device = "cpu", bool requiresGrad = false)
        {
            ShortTensor.CheckForCUDA (device);
            ...
            unsafe
            {
                fixed (long* psizes = size)
                {
                    return new ShortTensor (THSTensor_sparse (indices.Handle, values.Handle, (IntPtr)psizes, size.Length, (sbyte)ATenScalarMapping.Short, device, requiresGrad));
                }
            }
        }
        ...
        public ITorchTensor<short> Add(ITorchTensor<short> target, int scalar = 1)
        {
        ...
        public ITorchTensor<short> Mean()
        {
            return new ShortTensor(THSTensor_mean(handle));
        }
        ...
        // Operators overloading
        public static ShortTensor operator +(ShortTensor left, ShortTensor right)
        {
            return (ShortTensor)left.Add(right);
        }

        public static ShortTensor operator *(ShortTensor left, ShortTensor right)
        {
            return (ShortTensor)left.Mul(right);
        }

        public static ShortTensor operator -(ShortTensor left, ShortTensor right)
        {
            return (ShortTensor)left.Sub(right);
        }
    ...
    public struct IntTensor : ITorchTensor<int>
    {
        ...
        public static IntTensor From(int[] rawArray)
        {
            return From(rawArray, new long[] { (long)rawArray.Length });
        }
        ...
        public static IntTensor Sparse(ITorchTensor<long> indices, ITorchTensor<int> values, long[] size, string device = "cpu", bool requiresGrad = false)
        {
            IntTensor.CheckForCUDA (device);
            ...
            unsafe
            {
                fixed (long* psizes = size)
                {
                    return new IntTensor (THSTensor_sparse (indices.Handle, values.Handle, (IntPtr)psizes, size.Length, (sbyte)ATenScalarMapping.Int, device, requiresGrad));
                }
            }
        }
        ...
        public ITorchTensor<int> Add(ITorchTensor<int> target, int scalar = 1)
        {
        ...
        public ITorchTensor<int> Mean()
        {
            return new IntTensor(THSTensor_mean(handle));
        }
        ...
        // Operators overloading
        public static IntTensor operator +(IntTensor left, IntTensor right)
        {
            return (IntTensor)left.Add(right);
        }

        public static IntTensor operator *(IntTensor left, IntTensor right)
        {
            return (IntTensor)left.Mul(right);
        }

        public static IntTensor operator -(IntTensor left, IntTensor right)
        {
            return (IntTensor)left.Sub(right);
        }
    ...
    public struct LongTensor : ITorchTensor<long>
    {
        ...
        public static LongTensor From(IntPtr rawArray, long[] dimensions)
        {
            ...
            return new LongTensor(THSTensor_newLong(rawArray, dimensions, dimensions.Length, strides, strides.Length, (sbyte)ATenScalarMapping.Long));
        }
        ...
        public static LongTensor From(long[] rawArray)
        {
            return From(rawArray, new long[] { (long)rawArray.Length });
        }
        ...
        public static LongTensor Sparse(ITorchTensor<long> indices, ITorchTensor<long> values, long[] size, string device = "cpu", bool requiresGrad = false)
        {
            LongTensor.CheckForCUDA (device);
            ...
            unsafe
            {
                fixed (long* psizes = size)
                {
                    return new LongTensor (THSTensor_sparse (indices.Handle, values.Handle, (IntPtr)psizes, size.Length, (sbyte)ATenScalarMapping.Long, device, requiresGrad));
                }
            }
        }
        ...
        public ITorchTensor<long> Add(ITorchTensor<long> target, int scalar = 1)
        {
        ...
        public ITorchTensor<long> Mean()
        {
            return new LongTensor(THSTensor_mean(handle));
        }
        ...
        // Operators overloading
        public static LongTensor operator +(LongTensor left, LongTensor right)
        {
            return (LongTensor)left.Add(right);
        }

        public static LongTensor operator *(LongTensor left, LongTensor right)
        {
            return (LongTensor)left.Mul(right);
        }

        public static LongTensor operator -(LongTensor left, LongTensor right)
        {
            return (LongTensor)left.Sub(right);
        }
    ...
    public struct DoubleTensor : ITorchTensor<double>
    {
        ...
        public static DoubleTensor From(double[] rawArray)
        {
            return From(rawArray, new long[] { (long)rawArray.Length });
        }
        ...
        public static DoubleTensor Sparse(ITorchTensor<long> indices, ITorchTensor<double> values, long[] size, string device = "cpu", bool requiresGrad = false)
        {
            DoubleTensor.CheckForCUDA (device);
            ...
            unsafe
            {
                fixed (long* psizes = size)
                {
                    return new DoubleTensor (THSTensor_sparse (indices.Handle, values.Handle, (IntPtr)psizes, size.Length, (sbyte)ATenScalarMapping.Double, device, requiresGrad));
                }
            }
        }
        ...
        public ITorchTensor<double> Add(ITorchTensor<double> target, int scalar = 1)
        {
        ...
        public ITorchTensor<double> Mean()
        {
            return new DoubleTensor(THSTensor_mean(handle));
        }
        ...
        // Operators overloading
        public static DoubleTensor operator +(DoubleTensor left, DoubleTensor right)
        {
            return (DoubleTensor)left.Add(right);
        }

        public static DoubleTensor operator *(DoubleTensor left, DoubleTensor right)
        {
            return (DoubleTensor)left.Mul(right);
        }

        public static DoubleTensor operator -(DoubleTensor left, DoubleTensor right)
        {
            return (DoubleTensor)left.Sub(right);
        }
    ...
    public struct FloatTensor : ITorchTensor<float>
    {
        ...
        public static FloatTensor From(float[] rawArray)
        {
            return From(rawArray, new long[] { (long)rawArray.Length });
        }
        ...
        public static FloatTensor Sparse(ITorchTensor<long> indices, ITorchTensor<float> values, long[] size, string device = "cpu", bool requiresGrad = false)
        {
            FloatTensor.CheckForCUDA (device);
            ...
            unsafe
            {
                fixed (long* psizes = size)
                {
                    return new FloatTensor (THSTensor_sparse (indices.Handle, values.Handle, (IntPtr)psizes, size.Length, (sbyte)ATenScalarMapping.Float, device, requiresGrad));
                }
            }
        }
        ...
        public ITorchTensor<float> Add(ITorchTensor<float> target, int scalar = 1)
        {
        ...
        public ITorchTensor<float> Mean()
        {
            return new FloatTensor(THSTensor_mean(handle));
        }
        ...
        // Operators overloading
        public static FloatTensor operator +(FloatTensor left, FloatTensor right)
        {
            return (FloatTensor)left.Add(right);
        }

        public static FloatTensor operator *(FloatTensor left, FloatTensor right)
        {
            return (FloatTensor)left.Mul(right);
        }

        public static FloatTensor operator -(FloatTensor left, FloatTensor right)
        {
            return (FloatTensor)left.Sub(right);
        }
