...
namespace TorchSharp.Utils.tensorboard
{
    public static class Summary
    {
        ...
        /// <param name="rescale"></param>
        /// <returns></returns>
        public static Tensorboard.Summary.Types.Image make_image(Union<torch.Tensor, SKBitmap> img, double rescale = 1)
        {
            using SKBitmap image = img.MatchFunc((tensor) => {
