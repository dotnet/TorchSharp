    ...
    namespace Modules
    {
        ...
        public sealed class InstanceNorm2d : torch.nn.Module<Tensor, Tensor>
        {
            ...
            public override Tensor forward(Tensor tensor)
            {
                ...
                return ReturnCheckForErrors(THSNN_InstanceNorm2d_forward(handle.DangerousGetHandle(), tensor.Handle));
            }

            public Parameter? bias {
                get {
                    return ReturnNullParameterCheckForErrors(THSNN_InstanceNorm2d_bias(handle));
                }
                set {
            ...
            public Parameter? weight {
                get {
                    return ReturnNullParameterCheckForErrors(THSNN_InstanceNorm2d_weight(handle));
                }
                set {
                    // Please ignore, for now, that the litorch call thinks you *can* set it to null.
            ...
            public Tensor? running_mean {
                get {
                    return ReturnNullCheckForErrors(THSNN_InstanceNorm2d_get_mean(handle));
                }
                set {
                    // Please ignore, for now, that the litorch call thinks you *can* set it to null.
            ...
            public Tensor? running_var {
                get {
                    return ReturnNullCheckForErrors(THSNN_InstanceNorm2d_get_var(handle));
                }
                set {
                    // Please ignore, for now, that the litorch call thinks you *can* set it to null.
            ...
            public Tensor? num_batches_tracked {
                get {
                    return ReturnNullCheckForErrors(THSNN_InstanceNorm2d_get_batches(handle));
                }
            }
