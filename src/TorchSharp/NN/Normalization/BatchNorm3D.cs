    ...
    namespace Modules
    {
        ...
        public sealed class BatchNorm3d : torch.nn.Module<Tensor, Tensor>
        {
            ...
            public Parameter? bias {
                get {
                    return ReturnNullParameterCheckForErrors(THSNN_BatchNorm3d_bias(handle));
                }
                set {
            ...
            public Parameter? weight {
                get {
                    return ReturnNullParameterCheckForErrors(THSNN_BatchNorm3d_weight(handle));
                }
                set {
                    // Please ignore, for now, that the litorch call thinks you *can* set it to null.
            ...
            public Tensor? running_var {
                get {
                    return ReturnNullCheckForErrors(THSNN_BatchNorm3d_get_var(handle));
                }
                set {
                    // Please ignore, for now, that the litorch call thinks you *can* set it to null.
            ...
            public Tensor? num_batches_tracked {
                get {
                    return ReturnNullCheckForErrors(THSNN_BatchNorm3d_get_batches(handle));
                }
            }
