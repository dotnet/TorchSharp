...
namespace TorchSharp
{
    ...
    namespace Modules
    {
        ...
        /// </summary>
        public sealed class BatchNorm1d : BatchNorm
        {
            internal BatchNorm1d(long num_features, 
                            double eps, 
                            double momentum, 
                            bool affine, 
    ...
    public static partial class torch
    {
        public static partial class nn
        {
            ...
            /// <returns></returns>
            public static BatchNorm1d BatchNorm1d(long num_features, double eps = 1e-05, double momentum = 0.1, bool affine = true, bool track_running_stats = true, Device? device = null, ScalarType? dtype = null)
            {
                return new BatchNorm1d(num_features, eps, momentum, affine, track_running_stats, device, dtype);
            }
        }
    }
}
