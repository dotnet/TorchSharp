...
namespace TorchSharp
{
    ...
    public static partial class torch
    {
        ...
        public static partial class functional
        {
            ...
            /// When these buffers are None, this module always uses batch statistics. in both training and eval modes. Default: true</param>
            /// <returns></returns>
            static public Tensor BatchNorm1d(Tensor x, long features, double eps = 1e-05, double momentum = 0.1, bool affine = true, bool track_running_stats = true)
            {
                using (var d = nn.BatchNorm1d(features, eps, momentum, affine, track_running_stats)) {
                    return d.forward(x);
                }
            }
        }
