...
namespace TorchSharp
{
    ...
    public static partial class torch
    {
        ...
        public static partial class functional
        {
            ...
            /// <param name="bias">If true, adds a learnable bias to the output. Default: true</param>
            /// <returns>Tensor of shape (N,C_out,L_out)</returns>
            static public Tensor ConvTranspose1d(Tensor x, long inputChannel, long outputChannel, long kernelSize, long stride = 1, long padding = 0, long outputPadding = 0, long dilation = 1, PaddingModes paddingMode = PaddingModes.Zeros, long groups = 1, bool bias = true)
            {
                using (var d = nn.ConvTranspose1d(inputChannel, outputChannel, kernelSize, stride, padding, outputPadding, dilation, paddingMode, groups, bias)) {
                    return d.forward(x);
                }
            }
        }
