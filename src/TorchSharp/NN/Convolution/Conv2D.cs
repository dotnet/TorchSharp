...
{
    public class Conv2d : nn.Module
    {
        internal Conv2d (IntPtr handle, IntPtr boxedHandle) : base (handle, boxedHandle) { }

        [DllImport ("LibTorchSharp")]
        private static extern IntPtr THSNN_Conv2d_forward (nn.Module.HType module, IntPtr tensor);
        ...
        [DllImport("LibTorchSharp")]
        extern static IntPtr THSNN_Conv2d_bias(nn.Module.HType module);
        [DllImport("LibTorchSharp")]
        extern static void THSNN_Conv2d_set_bias(nn.Module.HType module, IntPtr tensor);
        ...
        [DllImport("LibTorchSharp")]
        extern static IntPtr THSNN_Conv2d_weight(nn.Module.HType module);
        [DllImport("LibTorchSharp")]
        extern static void THSNN_Conv2d_set_weight(nn.Module.HType module, IntPtr tensor);
    ...
    public static partial class functional
    {
        ...
        /// <param name="bias">If true, adds a learnable bias to the output. Default: true</param>
        /// <returns></returns>
        static public TorchTensor Conv2d(TorchTensor x, long inputChannel, long outputChannel, long kernelSize, Padding padding, long stride = 1, long dilation = 1, PaddingModes paddingMode = PaddingModes.Zeros, long groups = 1, bool bias = true)
        {
