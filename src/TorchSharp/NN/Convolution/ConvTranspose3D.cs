        ...
        public sealed class ConvTranspose3d : Convolution
        {
            ...
            public override Tensor forward(Tensor input)
            {
                if (ValidateShape(input, 3)) {
                    return ReturnCheckForErrors(THSNN_ConvTranspose3d_forward(handle, input.Handle));
                }
            ...
            public Parameter? bias {
                get {
                    return ReturnNullParameterCheckForErrors(THSNN_ConvTranspose3d_bias(handle));
                }
                set {
            ...
            public Parameter? weight {
                get {
                    return ReturnNullParameterCheckForErrors(THSNN_ConvTranspose3d_weight(handle));
                }
                set {
                    // Please ignore, for now, that the litorch call thinks you *can* set it to null.
