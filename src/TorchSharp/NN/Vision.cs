...
namespace TorchSharp
{
    ...
    public static partial class nn
    {
        ...
        public static partial class functional
        {
            ...
            {
                using (var d = nn.Upsample(size, scale_factor, UpsampleMode.Bilinear, alignCorners)) {
                    return d.forward(x);
                }
            }
            ...
            {
                using (var d = nn.Upsample(size, scale_factor, UpsampleMode.Nearest, alignCorners)) {
                    return d.forward(x);
                }
            }
        }
