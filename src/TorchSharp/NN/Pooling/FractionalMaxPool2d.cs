...
namespace TorchSharp
{
    ...
    namespace Modules
    {
        ...
        /// </summary>
        public sealed class FractionalMaxPool2d : ParamLessModule<Tensor, Tensor>
        {
                    ...
                    unsafe {
                        fixed (long* pkernelSize = kernel_size, poutputSize = output_size) {
                            fixed (double* poutputRatio = output_ratio) {
                                var resOutput = THSTensor_fractional_max_pool2d(input.Handle, (IntPtr)pkernelSize, kernel_size.Length, (IntPtr)poutputSize, output_size.Length, (IntPtr)poutputRatio, output_ratio.Length, out var resIndices);
