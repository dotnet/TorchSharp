...
namespace TorchSharp
{
    public static partial class torch
    {
        ...
        public sealed partial class Tensor
        {
            ...
            /// <returns></returns>
            public Tensor conv1d(Tensor weight, Tensor? bias = null,
                long? stride = null,
                long? padding = null,
                long? dilation = null,
                long groups = 1)
            ...
            /// <param name="groups"></param>
            /// <returns></returns>
            public Tensor conv2d(Tensor weight, Tensor? bias = null,
                long[]? strides = null,
                long[]? padding = null,
                long[]? dilation = null,
                long groups = 1)
            ...
            /// <param name="groups"></param>
            /// <returns></returns>
            public Tensor conv3d(Tensor weight, Tensor? bias = null,
                long[]? strides = null,
                long[]? padding = null,
                long[]? dilation = null,
                long groups = 1)
            ...
            /// <param name="groups"></param>
            /// <returns></returns>
            public Tensor conv_transpose1d(Tensor weight, Tensor? bias = null,
                long? stride = null,
                long? padding = null,
            ...
            /// <param name="groups"></param>
            /// <returns></returns>
            public Tensor conv_transpose2d(Tensor weight, Tensor? bias = null,
                long[]? strides = null,
                long[]? padding = null,
                long[]? outputPadding = null,
                long[]? dilation = null,
            ...
            /// <param name="groups"></param>
            /// <returns></returns>
            public Tensor conv_transpose3d(Tensor weight, Tensor? bias = null,
                long[]? strides = null,
                long[]? padding = null,
                long[]? outputPadding = null,
                long[]? dilation = null,
            ...
            /// <returns></returns>
            public Tensor max_pool1d(long kernelSize, long? stride = null,
            ...
            /// <param name="ceil_mode"></param>
            /// <returns></returns>
            public (Tensor output, Tensor indices) max_pool1d_with_indices(long kernelSize, long? stride = null,
                long? padding = null, long? dilation = null, bool ceil_mode = false)
            {
                var kernelSizes = new long[] { kernelSize };
                var strides = new long[] { stride ?? 1 };
            ...
            /// <param name="ceil_mode"></param>
            /// <returns></returns>
            public Tensor max_pool2d(long[] kernelSize, long[]? strides = null,
                long[]? padding = null, long[]? dilation = null, bool ceil_mode = false)
            {
            ...
            /// <param name="ceil_mode"></param>
            /// <returns></returns>
            public (Tensor output, Tensor indices) max_pool2d_with_indices(long[] kernelSize, long[]? strides = null,
                long[]? padding = null, long[]? dilation = null, bool ceil_mode = false)
            {
                strides = strides ?? kernelSize.Select(x => 1L).ToArray();
                padding = padding ?? kernelSize.Select(x => 0L).ToArray();
            ...
            /// <param name="ceil_mode"></param>
            /// <returns></returns>
            public Tensor max_pool3d(long[] kernelSize, long[]? strides = null,
                long[]? padding = null, long[]? dilation = null, bool ceil_mode = false)
            {
                strides = strides ?? kernelSize.Select(x => 1L).ToArray();
                padding = padding ?? kernelSize.Select(x => 0L).ToArray();
            ...
            /// <param name="ceil_mode"></param>
            /// <returns></returns>
            public (Tensor output, Tensor indices) max_pool3d_with_indices(long[] kernelSize, long[]? strides = null,
                long[]? padding = null, long[]? dilation = null, bool ceil_mode = false)
            {
                strides = strides ?? kernelSize.Select(x => 1L).ToArray();
                padding = padding ?? kernelSize.Select(x => 0L).ToArray();
            ...
            /// <returns></returns>
            public Tensor maxunpool2d(Tensor indices, long[] outputSize)
            {
                unsafe {
            ...
            /// <param name="padding"></param>
            /// <returns></returns>
            public Tensor maxunpool3d(Tensor indices, long[] outputSize, long[] strides, long[] padding)
            {
                unsafe {
            ...
            /// <returns></returns>
            public Tensor avg_pool1d(long kernelSize, long? stride = null,
            ...
            /// <param name="count_include_pad"></param>
            /// <returns></returns>
            public Tensor avg_pool2d(long[] kernelSizes,
                long[]? strides = null,
                long[]? paddings = null,
            ...
            /// <param name="count_include_pad"></param>
            /// <returns></returns>
            public Tensor avg_pool3d(long[] kernelSizes,
                long[]? strides = null,
                long[]? paddings = null,
                bool ceil_mode = false,
                bool count_include_pad = true)
            ...
            public Tensor avg_pool2d_backward(Tensor originalInput,
                long[] kernelSizes,
                long[]? strides = null,
                long[]? paddings = null,
                bool ceil_mode = false,
            ...
            public Tensor avg_pool3d_backward(Tensor originalInput,
                long[] kernelSizes,
                long[]? strides = null,
                long[]? paddings = null,
                bool ceil_mode = false,
            ...
            /// <param name="outputSize"></param>
            /// <returns></returns>
            public Tensor adaptive_avg_pool1d(long outputSize)
            {
            ...
            /// <returns></returns>
            public Tensor adaptive_avg_pool2d(long[] outputSizes)
            {
                unsafe {
                    fixed (long* poutputSize = outputSizes) {
                        var res =
            ...
            /// <param name="outputSizes"></param>
            /// <returns></returns>
            public Tensor adaptive_avg_pool3d(long[] outputSizes)
            {
                unsafe {
                    fixed (long* poutputSize = outputSizes) {
                        var res =
            ...
            /// <returns></returns>
            public Tensor upsample_nearest1d(long? outputSize, double? scaleFactor)
            {
            ...
            public Tensor upsample_nearest1d_backward(long? outputSize, long inputSize, double? scaleFactor)
            {
                var outputSizes = outputSize.HasValue ? new long[] { outputSize.Value } : null;
                var outputSizesLength = outputSize.HasValue ? 1 : 0;
            ...
            /// <returns></returns>
            public Tensor upsample_nearest2d(long[]? outputSizes = null, double[]? scaleFactors = null)
            {
            ...
            public Tensor upsample_nearest2d_backward(long[] inputSizes, long[]? outputSizes = null, double[]? scaleFactors = null)
            {
                var outputSizesLength = outputSizes == null ? 0 : outputSizes.Length;
                var scaleFactorsLength = scaleFactors == null ? 0 : scaleFactors.Length;
                unsafe {
            ...
            public Tensor upsample_nearest3d_backward(long[] inputSizes, long[]? outputSizes = null, double[]? scaleFactors = null)
            {
                var outputSizesLength = outputSizes == null ? 0 : outputSizes.Length;
                var scaleFactorsLength = scaleFactors == null ? 0 : scaleFactors.Length;
                unsafe {
            ...
            /// <param name="scaleFactors"></param>
            /// <returns></returns>
            public Tensor upsample_nearest3d(long[]? outputSizes = null, double[]? scaleFactors = null)
            {
                var outputSizesLength = outputSizes == null ? 0 : outputSizes.Length;
                var scaleFactorsLength = scaleFactors == null ? 0 : scaleFactors.Length;
                unsafe {
