...
namespace TorchSharp
{
    public static partial class torch
    {
        ...
        public static Tensor tensor(short scalar, Device? device = null, bool requires_grad = false)
        {
            ...
            return ReturnCheckForErrors(THSTensor_newInt16Scalar(scalar, (int)device.type, device.index, requires_grad));
        }
        ...
        /// </summary>
        [Pure]
        public static Tensor tensor(Memory<short> rawArray, ReadOnlySpan<long> dimensions, ScalarType? dtype = null, Device? device = null, bool requires_grad = false, string[]? names = null)
        {
            return _tensor_generic(rawArray, dimensions, (sbyte)ScalarType.Int16, dtype, device, requires_grad, names: names);
        }
